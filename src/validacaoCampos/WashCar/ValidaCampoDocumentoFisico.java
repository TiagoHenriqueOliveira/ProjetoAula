...
public class ValidaCampoDocumentoFisico extends PlainDocument{
	
	private static final long serialVersionUID = 1L;

	/*
	 * Objetivo dessa classe é para validar campos que irão receber informação de 
	 * outros documentos de pessoas fisicas
	 */
