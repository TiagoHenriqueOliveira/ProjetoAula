...
--
-- Host: localhost    Database: washcar
-- ------------------------------------------------------
...
CREATE TABLE `carro` (
  ...
  PRIMARY KEY (`idCarro`),
  KEY `fk_CARRO1_idx` (`MODELO`),
  KEY `fk_CARRO2_idx` (`CLIENTE`),
  CONSTRAINT `fk_CARRO1` FOREIGN KEY (`MODELO`) REFERENCES `modelo` (`idModelo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_CARRO2` FOREIGN KEY (`CLIENTE`) REFERENCES `cliente` (`idCliente`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `cidade` (
  ...
  `nome` varchar(50) NOT NULL,
  `UNIDADE_FEDERATIVA` int(11) NOT NULL,
  PRIMARY KEY (`idCidade`),
  KEY `fk_CIDADE1_idx` (`UNIDADE_FEDERATIVA`),
  CONSTRAINT `fk_CIDADE1` FOREIGN KEY (`UNIDADE_FEDERATIVA`) REFERENCES `unidade_federativa` (`idUnidadeFederativa`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `cliente` (
  ...
  KEY `fk_CLIENTE1_idx` (`EMPRESA`),
  CONSTRAINT `fk_CLIENTE1` FOREIGN KEY (`EMPRESA`) REFERENCES `empresa` (`idEmpresa`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `conta_pagar` (
  ...
  UNIQUE KEY `codigofornecedor_UNIQUE` (`codigofornecedor`),
  KEY `fk_CONTA_PAGAR1_idx` (`EMPRESA`),
  CONSTRAINT `fk_CONTA_PAGAR1` FOREIGN KEY (`EMPRESA`) REFERENCES `empresa` (`idEmpresa`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `conta_receber` (
  ...
  KEY `fk_CONTA_RECEBER1_idx` (`EMPRESA`),
  CONSTRAINT `fk_CONTA_RECEBER1` FOREIGN KEY (`EMPRESA`) REFERENCES `empresa` (`idEmpresa`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `empresa` (
  ...
  `inscricaoEstadual` varchar(17) DEFAULT NULL,
...
--
-- Table structure for table `item_tiposervico`
--

DROP TABLE IF EXISTS `item_tiposervico`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `item_tiposervico` (
  `idItemTipoServico` int(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `item_tiposervico_ibfk_1` FOREIGN KEY (`idOrdemServico`) REFERENCES `ordem_servico` (`idOrdemServico`),
  CONSTRAINT `item_tiposervico_ibfk_2` FOREIGN KEY (`idTipoServico`) REFERENCES `tipo_servico` (`idTipoServico`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `item_tiposervico`
--

LOCK TABLES `item_tiposervico` WRITE;
/*!40000 ALTER TABLE `item_tiposervico` DISABLE KEYS */;
/*!40000 ALTER TABLE `item_tiposervico` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `modelo` (
  ...
  KEY `fk_MODELO1_idx` (`MARCA`),
  CONSTRAINT `fk_MODELO1` FOREIGN KEY (`MARCA`) REFERENCES `marca` (`idMarca`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ordem_servico` (
  ...
  `osvCancelada` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`idOrdemServico`),
  KEY `fk_ORDEM_SERVICO1_idx` (`CARRO`),
  CONSTRAINT `fk_ORDEM_SERVICO1` FOREIGN KEY (`CARRO`) REFERENCES `carro` (`idCarro`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pessoa_fisica` (
  ...
  KEY `fk_PESSOA_FISICA1_idx` (`CLIENTE`),
  CONSTRAINT `fk_PESSOA_FISICA1` FOREIGN KEY (`CLIENTE`) REFERENCES `cliente` (`idCliente`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pessoa_juridica` (
  ...
  UNIQUE KEY `cnpj_UNIQUE` (`cnpj`),
  UNIQUE KEY `inscricaoEstadual_UNIQUE` (`inscricaoEstadual`),
  KEY `fk_PESSOA_JURIDICA1_idx` (`CLIENTE`),
  CONSTRAINT `fk_PESSOA_JURIDICA1` FOREIGN KEY (`CLIENTE`) REFERENCES `cliente` (`idCliente`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `unidade_federativa`
--
...
CREATE TABLE `unidade_federativa` (
  `idUnidadeFederativa` int(11) NOT NULL AUTO_INCREMENT,
  `nome` varchar(50) NOT NULL,
  `PAIS` int(11) NOT NULL,
  PRIMARY KEY (`idUnidadeFederativa`),
  KEY `fk_UNIDADE_FEDERATIVA1_idx` (`PAIS`),
  CONSTRAINT `fk_UNIDADE_FEDERATIVA1` FOREIGN KEY (`PAIS`) REFERENCES `pais` (`idPais`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `unidade_federativa`
--

LOCK TABLES `unidade_federativa` WRITE;
/*!40000 ALTER TABLE `unidade_federativa` DISABLE KEYS */;
INSERT INTO `unidade_federativa` VALUES (1,'Acre',1),(2,'Alagoas',1),(3,'Amazonas',1),(4,'Amapá',1),(5,'Bahia',1),(6,'Ceará',1),(7,'Distrito Federal',1),(8,'Espírito Santo',1),(9,'Goiás',1),(10,'Maranhão',1),(11,'Minas Gerais',1),(12,'Mato Grosso do Sul',1),(13,'Mato Grosso',1),(14,'Pará',1),(15,'Paraíba',1),(16,'Pernambuco',1),(17,'Piauí',1),(18,'Paraná',1),(19,'Rio de Janeiro',1),(20,'Rio Grande do Norte',1),(21,'Rondônia',1),(22,'Roraima',1),(23,'Rio Grande do Sul',1),(24,'Santa Catarina',1),(25,'Sergipe',1),(26,'São Paulo',1),(27,'Tocantins',1);
...
CREATE TABLE `usuario` (
  `idCadastroUsuario` int(11) NOT NULL AUTO_INCREMENT,
...
-- Dump completed on 2015-09-03  0:25:37
